...
public class ThreeFragment extends Fragment {
    ...
    ArrayList<Integer> contentIdList5 = new ArrayList<>();
    ...
    class AsyncTaskClassSub extends android.os.AsyncTask<Integer, Data, Data> {
        ...
        protected Data doInBackground(Integer... integers) {
            ...
            Data data5 = getData(contentIdList5.get(position));
        ...
        protected void onPostExecute(Data data) {
            ...
            super.onPostExecute(data);dialogView = View.inflate(getActivity(), R.layout.detail_info, null);
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < parse_itemlist.length(); i++) {
                                ...
                                Data data5 = new Data();
                                data5.setFirstImage(imsi.getString("firstimage"));
                                data5.setTitle(imsi.getString("title"));

                                list.add(data5);

                                contentIdList5.add(Integer.valueOf(imsi.getString("contentid")));
                            }
                ...
                (Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            detailData5.setFirstImage(parse_itemlist.getString("firstimage"));
                            detailData5.setTitle(parse_itemlist.getString("title"));
                            detailData5.setAddr(parse_itemlist.getString("addr1"));
                            detailData5.setOverView(parse_itemlist.getString("overview"));

                            Log.d(TAG, detailData5.getTitle());
