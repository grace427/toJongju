...
public class OneFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        AsyncTaskClassMain async = new AsyncTaskClassMain();
        async.execute();
        ...
        adapter = new MyAdapter(getActivity(), list, new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (v.getTag() != null) {
                    ...
                    Log.d(TAG, "OneFrag아이템 클릭시 onClick에서 받는 포지션 : "+position);
                    AsyncTaskClassSub asyncSub = new AsyncTaskClassSub();
    ...
    public class AsyncTaskClassSub extends android.os.AsyncTask<Integer, Data, String> {
        ...
        protected String doInBackground(Integer... integers) {
            ...
            Log.d(TAG, "OneFrag의 doInBackground 받는 포지션 : "+position);

            Data data1 = getData(contentIdList.get(position));

            Log.d(TAG, "OneFrag의 doInBackground 생성한 data의 제목 : "+data1.getTitle());
        ...
        protected void onProgressUpdate(Data... values) {
            Data data1 = values[0];
            Log.d(TAG, "OneFrag의 onProgressUpdate 생성한 data의 제목 : "+data1.getTitle());
            ...
            txt_Detail_Info.setText(data1.getTitle() + "\n\n");
            txt_Detail_Info.append(data1.getAddr() + "\n\n");
            txt_Detail_Info.append(data1.getOverView() + "\n\n");
    ...
    private void getAreaBasedList() {
        ...
        String url = "http://api.visitkorea.or.kr/openapi/service/"
                ...
                + "&areaCode=1&contentTypeId=25&listYN=Y&arrange=P"
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < parse_itemlist.length(); i++) {
                                ...
                                Data data1 = new Data();
                                data1.setFirstImage(imsi.getString("firstimage"));
                                data1.setTitle(imsi.getString("title"));
    ...
    private Data getData(int contentID) {
                ...
                (Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            detailData1.setFirstImage(parse_itemlist.getString("firstimage"));
                            detailData1.setTitle(parse_itemlist.getString("title"));
                            detailData1.setAddr(parse_itemlist.getString("addr1"));
                            detailData1.setOverView(parse_itemlist.getString("overview"));

                            Log.d(TAG, " One frg : "+detailData1.getTitle());
        ...
        queue.add(jsObjRequest);
        Log.d(TAG, "getDATA에서 : " + detailData1);
        return detailData1;
    }
